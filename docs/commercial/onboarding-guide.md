...
4. Review the dashboard first-run checklist and complete the next best action.
5. Open `/health` and confirm the platform is reachable.
...
2. Use the dashboard checklist to upload the first document.
