    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () =>
            import("@/views/governance/GovernanceCockpitView.vue"),
          meta: {
            allowedRoles: [
              "president",
              "vice_president",
        ...
        },
        {
          ...
          component: () =>
            import("@/views/secretary/SecretaryOverviewView.vue"),
          meta: {
        ...
        },
        {
          ...
          component: () =>
            import("@/views/announcements/AdminAnnouncementsView.vue"),
          meta: {
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () =>
            import("@/views/contributions/AdminContributionsView.vue"),
        ...
        },
        {
          ...
          component: () =>
            import("@/views/disciplinary/AdminDisciplinaryView.vue"),
          meta: { module: "disciplinary" },
        },
        {
          path: "events",
        ...
        },
        {
          ...
          component: () =>
            import("@/views/admin/AdminOnboardingWizardView.vue"),
          meta: {
...
router.beforeEach(async (to) => {
  ...
  if (
    ...
    auth.isAuthenticated &&
    auth.user &&
    !["admin", "treasurer", "principal_admin"].some((role) =>
      currentRoles.includes(role),
    )
  ) {
    return { name: "dashboard" };
  ...
  if (
    to.meta.requiresFinanceWorkspace &&
    (!tenant.isModuleEnabled("membership") ||
      !tenant.isModuleEnabled("contributions"))
  ) {
    return { name: "dashboard" };
  }
